...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.HAS_TKEEP {0}  ] $axis_data_fifo_0
  ...
  set_property -dict [ list CONFIG.PCW_IRQ_F2P_INTR {1} CONFIG.PCW_USE_FABRIC_INTERRUPT {1} CONFIG.PCW_USE_M_AXI_GP0 {1} CONFIG.PCW_USE_S_AXI_HP0 {1} CONFIG.preset {Microzed*}  ] $processing_system7_0
